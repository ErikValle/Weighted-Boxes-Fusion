...
def example_wbf_2_models(iou_thr=0.55, draw_image=True):
    ...
    boxes, scores, labels, nb = weighted_boxes_fusion(boxes_list, scores_list, labels_list, weights=weights, iou_thr=iou_thr, skip_box_thr=[0.3,0.5])
...
def example_wbf_1_model(iou_thr=0.55, draw_image=True):
    ...
    boxes, scores, labels, nb = weighted_boxes_fusion([boxes_list], [scores_list], [labels_list], weights=None, iou_thr=iou_thr, skip_box_thr=[0.5, 0.6])
